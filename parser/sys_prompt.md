...
Выводи **исключительно** валидный JSON-объект без лишнего форматирования markdown, пояснений и т.д. **Только чистый JSON** вида:
{
    "1": {
        ...
        "address": "ул. Пушкина, дом 14",
        "work_time": "14:00-20:00",
        "work_months": "Октябрь-Ноябрь"
    },
    "2": {
        "homestay_type": "Общественный душ",
        "address": "проспект Ленина, дом 2",
        "work_time": "11:00-13:00",
        "work_months": "Круглый год"
    }
}
Где **"1", "2", ...** - порядковый номер полученного объекта.**"homestay_type"** - тип данного объекта (пункт обогрева, ночной приют и т.д.). **"address"** - адрес объекта. **"work_time"** - время работы. **"work_months"** - месяцы, в которые работает данный объект (если не указано - пиши "Круглый год").